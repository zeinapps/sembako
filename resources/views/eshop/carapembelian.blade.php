        ...
        <div class="row">
            ...
            <div class="col-sm-9 row">
                <div class="blog-post-area">
                    <h2 class="title text-center">Cara Pemesanan</h2>
                    <div class="single-blog-post" style="padding-left: 10px; padding-right: 10px;">
                        <h3>1. Kirim Pesanan Dengan HP/WA</h3>
<!--                        <div class="post-meta">
                            <ul>
                        ...
                        <p>Pemesanan Produk di lapak kami bisa dilakukan dengan cara pesan langsung dengan WA ke nomer <strong>{{Config::get('app.no_wa')}}</strong>. Tulis barang yang Anda pesan beserta jumlahnya.</p>
                        <br>
                        <h3>2. Kirim Pesanan Dengan Web</h3>
                    ...
                    <div class="single-blog-post" style="padding-left: 10px; padding-right: 10px;">
                        <h2 class="title text-center">Pengiriman Produk</h2>
                        ...
                        <br><p>Barang yang telah Anda pesan akan kami kirim ke tempat Anda berada sesuai petunjuk yang telah Anda berikan ke kami. Biaya pengiriman <strong>GRATIS</strong> jika total pembelian senilai di atas Rp50.000. Biaya kirim yang berlaku secara umum sebagai berikut:
                        <ol>
                        ...
                        Biaya kirim boleh <strong>di-Nego</strong> dan ditentukan oleh kesepakatan bersama.</p>
                        <br><p>Pembayaran dilakukan secara langsung bersamaan dengan serah terima barang pesanan Pelanggan.</p>
                        <br><p>Kami hanya melayani pemesanan produk dari pelanggan yang berdomisili di kawasan Kecamatan Karang Ploso, Kabupaten Malang. Khususnya Perumahan Karangploso View, Bumi Perkasa, Arjuna Gumilang, Permata Regency, GPA, dan sekitarnya. Saran dan kritik yang membangun bisa dikirim lewat nomer WA {{Config::get('app.no_wa')}}. </p>
                        <br><p>Aturan ini bisa berubah sewaktu-waktu dan akan diperbarui sesuai kebijakan yang berlaku. </p>
