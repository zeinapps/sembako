                ...
                <div class="product-details"><!--product-details-->
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            @if($produk->suka)
                                <a id="link_suka_{{$produk->id}}" href="javascript: void(0)" onclick="tidaksuka({{$produk->id}})" class="btn btn-success "><i class="fa fa-star"></i> Suka</a>
                            @else
                                <a id="link_suka_{{$produk->id}}" href="javascript: void(0)" onclick="suka({{$produk->id}})" class="btn btn-warning "><i class="fa fa-star-o"></i> Suka?</a>
                            @endif
                            <br>
